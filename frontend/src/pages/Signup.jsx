      ...
      <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            ...
            <select
              className="w-full px-4 py-3 border rounded-lg text-base focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all bg-white"
              value={role}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-brand-600 hover:bg-brand-700 text-white font-semibold py-3 px-4 rounded-lg text-base transition-colors mt-2 disabled:opacity-50"
          >
